...
if rad=='Home':
    ...
    st.image("https://4.bp.blogspot.com/-w9Lntz07aSw/XIOxtRHLf3I/AAAAAAAAF1o/UVZGdOTyxGwuAaWqCseMnamGySYuQye0gCLcBGAs/s1600/Screenshot_1.png")
...
if rad=='Breast Cancer Prediction':
    st.image('https://miro.medium.com/v2/resize:fit:1000/1*VooY3EOMyiA5smL3-s9Neg.png')
...
if rad=='Lung Cancer Prediction':
    st.image('https://miro.medium.com/max/712/1*JC2TAaZFkhRLvyXi6VLq6g.jpeg')
